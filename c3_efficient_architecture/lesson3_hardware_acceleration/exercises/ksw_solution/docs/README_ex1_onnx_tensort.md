...
![alt text](readme_imgs/tensor_rt/tensor_rt_1.png)
Citation: Slide from Jeremy Cohen

# ----------------------------------------------------------
TODO : For all sections below complete the README, use the pictures in the readme_imgs to complete the readme
